...
/**
 * 自定义的service用来和数据库进行操作. 即以后我们要通过数据库保存权限.则需要我们继承UserDetailsService
 * 
 */
...
public class DBUserService implements UserDetailsService {
	...
	protected static Logger logger = Logger.getLogger("DBUserService");
	
	@Autowired
	private DBUserDao db;
	...
	public UserDetails loadUserByUsername(String username)
		...
		try {
			...
			DbUser dbUser = db.getDatabase(username);
